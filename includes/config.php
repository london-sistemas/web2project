...
$w2Pconfig['dbhost'] = getenv("LMVZ_DBHOST");
$w2Pconfig['dbname'] = getenv("LMVZ_DBNAME"); // Your web2Project Database Name
$w2Pconfig['dbuser'] = getenv("LMVZ_DBUSER"); // Your MySQL Username
$w2Pconfig['dbpass'] = getenv("LMVZ_DBPASS"); // Your MySQL Password
